...
unsigned int nStakeMinAge = 6 * 60 * 60; // min age is 6 hours
...
const string strMessageMagic = "KurdCoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    {
    nSubsidy = YEAR_REWARD * nCoinAge * 33 / (365 * 33 + 8);
    }
...
#ifdef ENABLE_WALLET
// kurdcoin: attempt to generate suitable proof-of-stake
