...
{
    resize(850+95, 550);
    setWindowTitle(tr("KurdCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a KurdCoin address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(sendCoinsAction);

    historyAction = new QAction(QIcon(":/icons/history"), tr("&Transaction History"), this);
    ...
    blockExplorerAction = new QAction(QIcon(":/icons/link"), tr("&Block Explorer"), this);
    blockExplorerAction->setToolTip(tr("Go to the BlockExperts KurdCoin Block Explorer"));

    websiteAction = new QAction(QIcon(":/icons/globe"), tr("&Website"), this);
    websiteAction->setToolTip(tr("Go to the Official KurdCoin Website"));
    ...
    aboutAction = new QAction(tr("&About KurdCoin"), this);
    aboutAction->setToolTip(tr("Show information about KurdCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for KurdCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("KurdCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("KurdCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KurdCoin network", "", count));
}
...
{
    QDesktopServices::openUrl(QUrl("http://www.kurdcoin.org"));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid KurdCoin address or malformed URI parameters."));
    }
